...
namespace LuaBinding
{
	internal partial class CompilerParametersPanelWidget
	{
		...
		protected virtual void Build ()
		{
			...
			this.filechooserbutton3 = new global::Gtk.FileChooserButton (global::Mono.Unix.Catalog.GetString ("Select Executable"), ((global::Gtk.FileChooserAction)(0)));
			this.filechooserbutton3.TooltipMarkup = "(Moai and Love Only) Select the excutable that will run the project";
			this.filechooserbutton3.Name = "filechooserbutton3";
			this.MainTable.Add (this.filechooserbutton3);
			global::Gtk.Table.TableChild w1 = ((global::Gtk.Table.TableChild)(this.MainTable [this.filechooserbutton3]));
			w1.TopAttach = ((uint)(2));
			...
			this.label2.LabelProp = global::Mono.Unix.Catalog.GetString ("Launcher");
